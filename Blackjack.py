...
def dealer_hit():
	...
	if dealer_spot < 5:
		try:
			...
			dcard = int(str(dealer_card).split("_", 1)[0])
			if dcard == 14:
				dcard = 11
				dealer_aces += 1
			...
			if dealer_spot == 0:
				# Resize Card
				dealer_image1 = resize_cards(f'cards/{str(dealer_card)}.png')
				# Output Card To Screen
				...
				# Resize Card
				dealer_image2 = resize_cards(f'cards/{str(dealer_card)}.png')
				# Output Card To Screen
				...
				# Resize Card
				dealer_image3 = resize_cards(f'cards/{str(dealer_card)}.png')
				# Output Card To Screen
				...
				# Resize Card
				dealer_image4 = resize_cards(f'cards/{str(dealer_card)}.png')
				# Output Card To Screen
				...
				# Resize Card
				dealer_image5 = resize_cards(f'cards/{str(dealer_card)}.png')
				# Output Card To Screen
